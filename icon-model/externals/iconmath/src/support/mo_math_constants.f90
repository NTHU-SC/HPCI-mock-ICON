...
!! These constants are provided to more significant digits than is necessary
!! for a 64-bit double precision number; they may be used for other purposes
!! where the extra precision is necessary or useful.
!!
