...
struct {
  ...
  char const * file_name;
                                    ...
                                    "A_2", "D_2", "E_2", "J_2"},
                    .num_fields = 8,
                    .file_name = "icon_grid_0030_R02B03_G.nc"},
                   ...
                   {.field_names = {"B_1", "C_1", "D_1", "G_1",
                                    "B_2", "C_2", "D_2", "G_2"},
                    .num_fields = 8,
                    .file_name = "icon_grid_0036_R02B04_O.nc"},
                   ...
                   {.field_names = {"G_1", "H_1", "I_1", "J_1",
                                    "G_2", "H_2", "I_2", "J_2"},
                    .num_fields = 8,
                    .file_name = "icon_grid_0043_R02B04_G.nc"}};
...
int main (int argc, char *argv[]) {
  ...
  char const * gridDirname = ""; // default grid directory
  parse_arguments(argc, argv, &configFilename, &gridDirname);
  ...
  for (unsigned i = 0; i < num_components; ++i) {
    ...
    char * grid_filename =
      malloc(
        strlen(gridDirname) +
        strlen(
          grid_config[config_per_global_rank[global_rank].grid_idx[i]].
            file_name) + 1);
    sprintf(
      grid_filename, "%s%s", gridDirname,
