...
/**
 * gets the field interpolation exchange (used for raw exchange) of a
 * specified put operation
 * @param[in] field
 * @param[in] put_idx index of the put operation
 * @return field interpolation exchange of specified put operation
 * @remarks calling this routine for a coupling field that
 *          has a different exchange type than SOURCE yields
 *          undefined results
 * @see get_coupling_field_num_puts
 ...
 * @param[in] field
 * @param[in] put_idx index of the put operation
 * @return true if source field is configured for raw exchange
 */
int
yac_get_coupling_field_put_op_use_raw_exchange(struct coupling_field * field,
                                               unsigned put_idx);

/**
 * returns whether a target field is configured for raw exchange
 * @param[in] field
 * @return true if target field is configured for raw exchange
 */
 ...
 * @param[in] cpl_field
 * @return true if target field is configured for fractional masking
 *
 */
...
/**
 * gets the field interpolation exchange (used for raw data exchange) of the
 * get operation
 * @param[in] field
 * @return field interpolation exchange of the get operation
 * @remarks calling this routine for a coupling field that
 *          has a different exchange type than TARGET yields
 *          undefined results
 */
...
/**
 * gets the field interpolation weight data (used for raw data exchange) of the
 * get operation
 * @param[in] field
 * @return field interpolation weight data of the get operation
 * @remarks calling this routine for a coupling field that
 *          has a different exchange type than TARGET yields
 *          undefined results
 */
...
/**
 * gets the source field buffer sizes (used for raw data exchange) of the
 * get operation
 * @param[in]  field
 * @param[out] num_src_fields         number of source fields
 * @param[out] src_field_buffer_sizes size of the buffer for each source field
 * @remarks calling this routine for a coupling field that
 *          has a different exchange type than TARGET yields
 *          undefined results
 */
 ...
 * @param[in,out] field
 * @param[in]     event                  event of the operation
 * @param[in]     interpolation_exchange interpolation exchange to be executed
 * @remarks the coupling field takes control of the input data, it will be
 *          free/deleted by the coupling field
 */
 ...
 * @param[in]     event                  event of the operation
 * @param[in]     interpolation_exchange interpolation exchange to be executed
 * @param[in]     interp_weights_data    interpolation weight data to be
 *                                       executed
 * @remarks the coupling field takes control of the input data, it will be
 *          free/deleted by the coupling field
 */
