...
static void utest_do_test(
  struct interval_node *tree, size_t num_nodes, struct overlaps *overlaps);
...
static void utest_do_test(struct interval_node *tree, size_t num_nodes,
