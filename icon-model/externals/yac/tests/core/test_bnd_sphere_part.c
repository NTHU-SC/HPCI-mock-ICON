...
static void utest_random_test(size_t count);
static void utest_random_test_big(size_t count);
static void utest_empty_test();
static void utest_zero_balance_point();
static void utest_mean_point_test();
...
int main(void) {
  ...
  for (size_t i = 0; i < 10; ++i) {
    ...
    utest_random_test_big(50);
  }
  utest_empty_test();
  utest_zero_balance_point();
  utest_mean_point_test();
...
static void utest_zero_balance_point() {
  ...
  struct bounding_circle utest_zero_balance_point_bnd_circles[6] =
  ...
  struct bnd_sphere_part_search * search =
    yac_bnd_sphere_part_search_new(
      utest_zero_balance_point_bnd_circles,
      sizeof(utest_zero_balance_point_bnd_circles)/
        sizeof(utest_zero_balance_point_bnd_circles[0]));
