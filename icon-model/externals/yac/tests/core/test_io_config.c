 ...
 *  \test
 * A test for the configuration of the parallel io settings via
 * environment variables.
 */

static void utest_check_io_config(
  MPI_Comm comm, int ref_local_is_io, int * ref_io_ranks, int ref_num_io_ranks);
static void utest_generate_node_wise_ref_data(
...
int main(void) {
  ...
  { // limited number of ranks per node
    ...
    utest_generate_node_wise_ref_data(
