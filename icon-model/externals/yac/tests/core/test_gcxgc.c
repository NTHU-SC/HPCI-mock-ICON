...
int main (void) {
   ...
   utest_test_gcxgc(-45,  45,                     // point a
                0,   0,                     // point b
              225,  45,                     // point c
              135, -45,                     // point d
   ...
   utest_test_gcxgc(  67.5,  40, // point a
                67.5, -13, // point b
                 405,   0, // point c
                 450,   0, // point d
  ...
  // one of the two edge has length zero and is not on the other plane
   ...
   utest_test_gcxgc( 10,  10, // point a
               10,  10, // point b
              -10, -10, // point c
               10,  11, // point d
  ...
  // one of the two edge has length zero, is not on the other edge, but on the other plane
   ...
   utest_test_gcxgc(190,  -10, // point a
              170,   10, // point b
               10,   10, // point c
               10,   10, // point d
               10,   10, // reference point p
  ...
  // one of the two edge has length zero and is on the other edge
   ...
   utest_test_gcxgc(170,  10, // point a
              170,  10, // point b
              -10, -10, // point c
              -10, -10, // point d
               -1,  -1, // reference point p
...
static void utest_test_gcxgc(double lon_a, double lat_a, double lon_b, double lat_b,
                       double lon_c, double lat_c, double lon_d, double lat_d,
                       double lon_ref_p, double lat_ref_p,
                       double lon_ref_q, double lat_ref_q, int ref_ret_val) {
