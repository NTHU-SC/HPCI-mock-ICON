...
int main (void) {
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_latcxlatc(lon_coords[i][0],   30, // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_latcxlatc(lon_coords[i][0],   -15, // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_latcxlatc(lon_coords[i][0],   10, // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_latcxlatc(20, lat_coords[i],   // point a
      ...
      utest_latcxlatc(-80, lat_coords[i],   // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_latcxlatc(  0, lat_coords[i],           // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_latcxlatc(45    , lat_coords[i],   // point a
   ...
   utest_latcxlatc(180,  10, // point a
                  180,  10, // point b
                   -5,  10, // point c
                    5,  10, // point d
...
static void utest_latcxlatc(double lon_a, double lat_a, double lon_b, double lat_b,
                           double lon_c, double lat_c, double lon_d, double lat_d,
                           double lon_ref_p, double lat_ref_p,
                           double lon_ref_q, double lat_ref_q, int ref_ret_val) {
