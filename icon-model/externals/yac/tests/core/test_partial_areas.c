 ...
 *  \test
 * Tests for \ref yac_compute_overlap_areas routine.
 */

static void utest_check_partial_areas_deg(
...
static void utest_check_partial_areas_rad(
  double * tgt_lon, double * tgt_lat,
  enum yac_edge_type * tgt_edges, int tgt_count,
  double ** src_lons, double ** src_lats,
  enum yac_edge_type ** src_edges, int * src_counts, size_t nSourceCells);
...
static void utest_check_partial_areas(
  double * tgt_lon, double * tgt_lat,
  enum yac_edge_type * tgt_edges, int tgt_count,
  double ** src_lons, double ** src_lats,
  enum yac_edge_type ** src_edges, int * src_counts, size_t nSourceCells,
