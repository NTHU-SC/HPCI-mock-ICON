...
static void utest_test_gcxlatc(
...
int main (void) {
   ...
   utest_test_gcxlatc(-10, 10, // point a
                 10, 10, // point b
                -10,  0, // point c
                 10,  0, // point d
   ...
   utest_test_gcxlatc(  0,  90, // point a
                140,  60, // point b
                 90, -45, // point c
                 39, -45, // point d
   ...
   utest_test_gcxlatc(-10,  9, // point a
                 10, 10, // point b
                -10, 70, // point c
                 10, 70, // point d
                -10, 70, // reference point p
   ...
   utest_test_gcxlatc(-90,  0, // point a
                  0, 45, // point b
                -10, 45, // point c
                 10, 45, // point d
   ...
   utest_test_gcxlatc(15      ,  85, // point a
                180 + 15,  85, // point b
                10      ,  90, // point c
                20      ,  90, // point d
   ...
   utest_test_gcxlatc(30,  90, // point a
                30,  70, // point b
                10,  90, // point c
                20,  90, // point d
                 0,  90, // reference point p
   ...
   utest_test_gcxlatc(30, 70, // point a
                30, 70, // point b
                10, 60, // point c
                20, 60, // point d
   ...
   // the circle of latitude
   utest_test_gcxlatc( 15, 10, // point a
                 15, 10, // point b
                 10, 10, // point c
                 20, 10, // point d
   ...
   utest_test_gcxlatc(-5, -5, // point a
                 5,  5, // point b
                10, 89, // point c
                10, 89, // point d
                -1, -1, // reference point p
   ...
   utest_test_gcxlatc(-10, 0, // point a
                 10, 0, // point b
                -10, 0, // point c
                 10, 0, // point d
   ...
   utest_test_gcxlatc(  0, 0, // point a
                 10, 0, // point b
                -10, 0, // point c
                 10, 0, // point d
                  0, 0, // reference point p
   ...
   utest_test_gcxlatc( -5, 0, // point a
                  5, 0, // point b
                -10, 0, // point c
                 10, 0, // point d
   ...
   utest_test_gcxlatc(170, 0, // point a
                190, 0, // point b
                -10, 0, // point c
                 10, 0, // point d
                180, 0, // reference point p
...
static void utest_test_gcxlatc(double lon_a, double lat_a, double lon_b, double lat_b,
                         double lon_c, double lat_c, double lon_d, double lat_d,
                         double lon_ref_p, double lat_ref_p,
                         double lon_ref_q, double lat_ref_q, int ref_ret_val) {
