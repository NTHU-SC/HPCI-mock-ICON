...
static void utest_check_compare_circles(
  struct yac_circle * circle_a, int a_is_lat,
...
static void utest_check_compare_circles(struct yac_circle * circle_a, int a_is_lat,
                                  struct yac_circle * circle_b, int b_is_lat,
                                  int are_identical) {
