...
int main (void) {
   ...
   for (int i = 0; i < 4; ++i) {
      ...
      utest_loncxlatc( 20,  lat_coords[i&1],   // point a
...

   {
      ...
      utest_loncxlatc(a_lon/YAC_RAD, a_lat/YAC_RAD, // point a
...
static void utest_loncxlatc(double lon_a, double lat_a, double lon_b, double lat_b,
                           double lon_c, double lat_c, double lon_d, double lat_d,
                           double lon_ref_p, double lat_ref_p,
                           double lon_ref_q, double lat_ref_q, int ref_ret_val) {
