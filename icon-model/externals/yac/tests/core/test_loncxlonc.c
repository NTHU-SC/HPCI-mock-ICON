...
int main (void) {
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_loncxlonc(0,  lat_coords[i][0],   // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_loncxlonc(10,  lat_coords[i][0],   // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_loncxlonc(30, lat_coords[i][0],         // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_loncxlonc(-45    ,  lat_coords[i][0],   // point a
   ...
   for (int i = 0; i < 2; ++i) {
      ...
      utest_loncxlonc(60, lat_coords[i][0],   // point a
   ...
   for (int i = 0; i < 8; ++i) {
      ...
      utest_loncxlonc(lon_coords[i>>2], lat_coords[i&1],          // point a
   ...
   for (int j = 0; j < 2; ++j) {
      ...
      for (int i = 0; i < 2; ++i) {
         ...
         utest_loncxlonc(lon_coords[i],   lat_coords[j][0],   // point a
   ...
   for (int i = 0; i < 4; ++i) {
      ...
      int ret_val[2] = {p_between_ab+q_between_cd,
                        p_between_ab+p_between_cd};
      utest_loncxlonc(  0,  lat_coords[0][i&1], // point a
   ...
   for (int j = 0; j < 4; ++j) {
      ...
      for (int i = 0; i < 2; ++i) {
         double lat_coords[2][2] = {{-85, 85}, {-90, 90}};
         utest_loncxlonc(lon_coords[j&1],      lat_coords[0][i&1],     // point a
   ...
   for (int j = 0; j < 2; ++j) {
      ...
      for (int i = 0; i < 2; ++i) {
         ...
         utest_loncxlonc(lon_coords[j],   lat_coords[i][0],   // point a
   ...
   for (int i = 0; i < 2; ++i) {
      for (int j = 0; j < 2; ++j) {
      double lat_coords[2][2] = {{-85, -80}, {85, 80}};
      utest_loncxlonc(60,     lat_coords[i][j],   // point a
...
static void utest_loncxlonc(double lon_a, double lat_a, double lon_b, double lat_b,
                           double lon_c, double lat_c, double lon_d, double lat_d,
                           double lon_ref_p, double lat_ref_p,
                           double lon_ref_q, double lat_ref_q, int ref_ret_val) {
