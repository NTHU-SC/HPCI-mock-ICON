 ...
 *  \test
 * Test for \ref yac_cell_lat_clipping routine.
 */

static void utest_lat_clipping(struct yac_grid_cell cells,
...
static double utest_get_intersection(
...
int main (void) {
  ...
  // a triangle cell covering the pole
  temp_lon[0] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {120, 70}}, 80);
  temp_lon[1] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {240, 70}}, 80);
  utest_lat_clipping(
    generate_cell_deg(
       (double[]){0,120,240},
  ...
  // a triangle cell covering the pole
  temp_lon[0] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {120, 70}}, 72);
  temp_lon[1] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{120, 70}, {240, 70}}, 72);
  ...
  temp_lon[3] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {240, 70}}, 72);
  utest_lat_clipping(
    generate_cell_deg(
       (double[]){0,120,240},
       (double[]){85,70,70}, gc_edges, 3),
  ...
  // a triangle cell covering the pole
  temp_lon[0] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {120, 70}}, 84);
  temp_lon[1] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {120, 70}}, 80);
  temp_lon[2] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {240, 70}}, 80);
  temp_lon[3] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {240, 70}}, 84);
  utest_lat_clipping(
    generate_cell_deg(
       (double[]){0,120,240},
       (double[]){85,70,70}, gc_edges, 3),
  ...
  temp_lon[1] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 85}, {120, 70}}, 72);
  temp_lon[2] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{240, 70}, {120, 70}}, 72);
  ...
  temp_lon[0] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 90}, {120, 80}}, 85);
  temp_lon[1] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 90}, {240, 80}}, 85);
  utest_lat_clipping(
    generate_cell_deg(
       (double[]){0,120,240},
  ...
  // a triangle cell touching the pole
  temp_lon[0] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{0, 0}, {10, 5}}, 2.5);
  temp_lon[1] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{10, -5}, {10, 5}}, 2.5);
  temp_lon[2] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{10, -5}, {10, 5}}, -2.5);
  temp_lon[3] =
    utest_get_intersection(YAC_GREAT_CIRCLE_EDGE, (double[2][2]){{10, -5}, {0, 0}}, -2.5);
  utest_lat_clipping(
    generate_cell_deg(
       (double[]){0,10,10},
...
static void utest_lat_clipping(struct yac_grid_cell cell,
                              double deg_lat_bounds[2],
                              struct yac_grid_cell * ref_cells,
                              unsigned num_ref_cells) {
