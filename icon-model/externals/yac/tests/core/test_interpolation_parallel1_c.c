...
int main(int argc, char *argv[]) {
  ...
  if (tgt_flag) utest_target_main(split_comm, reorder_type);
  else          utest_source_main(split_comm, reorder_type);
