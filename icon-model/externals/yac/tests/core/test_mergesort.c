...
static int utest_compare_test_struct(const void * a, const void * b) {
...
int main (void) {

  {
    ...
    qsort(ref, len, sizeof(ref[0]), utest_compare_test_struct);
    yac_mergesort(a, len, sizeof(ref[0]), utest_compare_test_struct);
