...
#define TO_POINTER(a) (utest_to_pointer(&a, sizeof(a)))

static void * utest_to_pointer(void * data, size_t size_data) {
...
static void utest_LLtoXYZ(double lon, double lat, double p_out[]) {
