...
static void utest_run_comp_a(char const * config_dir);
static void utest_run_comp_b(char const * config_dir);
...
int main(int argc, char** argv) {
  ...
  switch(rank) {
    ...
    case(1):
      utest_run_comp_a(argv[1]);
      break;
    case(2):
      utest_run_comp_b(argv[1]);
      break;
    default:
...
static void utest_run_comp_a(char const * config_dir) {
  ...
  */
  ...
  { // test yac_cget_field_source
    ...
    if (strcmp(src_comp_name, "comp_A") ||
        strcmp(src_grid_name, "grid_A") ||
        strcmp(src_field_name, "A_to_B_src"))
      PUT_ERR("ERROR in yac_cget_field_source");
  }
...
static void utest_run_comp_b(char const * config_dir) {
  ...
  */
  ...
  { // test yac_cget_field_source_instance
    const char* src_comp_name;
    const char* src_grid_name;
    const char* src_field_name;
    yac_cget_field_source_instance(
      default_instance_id, "comp_B", "grid_B", "A_to_B_tgt",
      &src_comp_name, &src_grid_name, &src_field_name);
