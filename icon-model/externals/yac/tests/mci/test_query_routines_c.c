...
int main(void) {
  ...
  if (rank_type == 0) {
    ...
    // test C to Python interfaces
    {
      ...
      if (!is_defined) PUT_ERR("error in yac_cdefault_instance_defined_c2py");

      yac_cget_instance_rank_c2py(yac_id, &rank);
      if (rank != global_rank)
        PUT_ERR("error in yac_cget_instance_rank_c2py");

      yac_cget_instance_size_c2py(yac_id, &size);
      if (size != global_size)
        PUT_ERR("error in yac_cget_instance_size_c2py");
    }
    ...
    if (rank_type > 1) {
      ...
      yac_cdef_grid_reg2d(
        ...
        (double[]){0.*YAC_RAD,180.*YAC_RAD},
        (double[]){-45.*YAC_RAD,45.*YAC_RAD}, &grid_id);

      int point_id;
      yac_cdef_points_reg2d(
        grid_id, (int[]){1,1}, YAC_LOCATION_CELL,
        (double[]){90.*YAC_RAD}, (double[]){0.*YAC_RAD}, &point_id);
      ...
      if (rank_type > 2) {
        ...
        if (rank_type > 3) {
          ...
          //----------------------------------------
          if (!yac_cget_field_is_defined(comp_name, grid_name, field_name))
            PUT_ERR("ERROR in yac_cget_field_is_defined");
          if (yac_cget_field_is_defined(comp_name, grid_name, "undefined_field"))
            PUT_ERR("ERROR in yac_cget_field_is_defined");
          if (yac_cget_field_is_defined(comp_name, "undefined_grid", field_name))
            PUT_ERR("ERROR in yac_cget_field_is_defined");
          if (yac_cget_field_is_defined("undefined_comp", grid_name, field_name))
            PUT_ERR("ERROR in yac_cget_field_is_defined");
          if (!yac_cget_field_is_defined_instance(
                yac_id, comp_name, grid_name, field_name))
            PUT_ERR("ERROR in yac_cget_field_is_defined_instance");
          if (yac_cget_field_is_defined_instance(
                yac_id, comp_name, grid_name, "undefined_field"))
            PUT_ERR("ERROR in yac_cget_field_is_defined_instance");
          if (yac_cget_field_is_defined_instance(
                yac_id, comp_name, "undefined_grid", field_name))
            PUT_ERR("ERROR in yac_cget_field_is_defined_instance");
          if (yac_cget_field_is_defined_instance(
                yac_id, "undefined_comp", grid_name, field_name))
            PUT_ERR("ERROR in yac_cget_field_is_defined_instance");
