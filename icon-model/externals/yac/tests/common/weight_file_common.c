...
void write_cdo_weight_file(char const * file_name, int const * src_id,
                           int const * tgt_id, double const * weights,
                           unsigned num_links,
                           char const * src_grid_name,
                           char const * tgt_grid_name) {
  ...
  // put attributes
  char const title[] = "CDO remapping";
  YAC_HANDLE_ERROR(nc_put_att_text(ncid, NC_GLOBAL, "title",
                                   strlen(title), title));
  YAC_HANDLE_ERROR(nc_put_att_text(ncid, NC_GLOBAL, "source_grid",
                                   strlen(src_grid_name), src_grid_name));
  YAC_HANDLE_ERROR(nc_put_att_text(ncid, NC_GLOBAL, "dest_grid",
                                   strlen(tgt_grid_name), tgt_grid_name));
