...
contains
  ...
  subroutine update_host(this)
    ...
    !$ACC UPDATE HOST(this%q_liq) IF(associated(this%q_liq))
    !$ACC UPDATE HOST(this%re_liq) IF(associated(this%re_liq))
    !$ACC UPDATE HOST(this%q_ice) IF(associated(this%q_ice))
    !$ACC UPDATE HOST(this%re_ice) IF(associated(this%re_ice))
  ...
  subroutine update_device(this)
    ...
    !$ACC UPDATE DEVICE(this%q_liq) IF(associated(this%q_liq))
    !$ACC UPDATE DEVICE(this%re_liq) IF(associated(this%re_liq))
    !$ACC UPDATE DEVICE(this%q_ice) IF(associated(this%q_ice))
    !$ACC UPDATE DEVICE(this%re_ice) IF(associated(this%re_ice))
