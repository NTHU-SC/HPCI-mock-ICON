...
! ======================================================================================== 
  ...
  ALLOCATE( p_biomBurn_prop%frp              (nproma,nblks)    ) 
  ALLOCATE( p_biomBurn_prop%flux_sh          (nproma,nblks)    )
  ALLOCATE( p_biomBurn_prop%flux_co          (nproma,nblks)    )
  ALLOCATE( p_biomBurn_prop%flux_co2         (nproma,nblks)    )
  ALLOCATE( p_biomBurn_prop%flux_cr          (nproma,nblks)    )
  ALLOCATE( p_biomBurn_prop%flux_h2o         (nproma,nblks)    )
  ...
  p_biomBurn_prop%frp               = UNDEF_REAL_ART 
  p_biomBurn_prop%flux_sh           = UNDEF_REAL_ART
  p_biomBurn_prop%flux_co           = UNDEF_REAL_ART
  p_biomBurn_prop%flux_co2          = UNDEF_REAL_ART
  p_biomBurn_prop%flux_cr           = UNDEF_REAL_ART
  p_biomBurn_prop%flux_h2o          = UNDEF_REAL_ART
