...
! ART
  ...
  TYPE t_art_biomBurn_properties
    ...
    REAL(wp),POINTER        :: &
      ...
      &  flux_co(:,:),             &  !< flux of carbon monoxide (kg /s m2), GFAS product
      &  frp(:,:),                 &  !< FRP GFAS product (W/m2)
      &  flux_sh(:,:),             &  !< flux of sensible heat
      &  flux_co2(:,:),            &  !< flux of CO2 (kg /s m2), GFAS product
      &  flux_h2o(:,:),            &  !< flux of H2O (kg /s m2)
      &  flux_cr(:,:)                 !< flux of burned fuel load (kg /s m2),GFAS product
