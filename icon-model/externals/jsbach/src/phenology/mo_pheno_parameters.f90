...
MODULE mo_pheno_parameters
  ...
  !$ACC   CREATE(pheno_param_jsbach%SG, pheno_param_jsbach%RG, pheno_param_jsbach%GRS, pheno_param_jsbach%CRP) &
  !$ACC   CREATE(pheno_param_jsbach%FR, pheno_param_jsbach)
