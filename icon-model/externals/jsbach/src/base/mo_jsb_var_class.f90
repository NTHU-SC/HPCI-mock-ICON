...
MODULE mo_jsb_var_class
  ...
  TYPE, ABSTRACT :: t_jsb_var
    ...
    LOGICAL                       :: transfer_all = .FALSE.      !< Flag indicating if all matter should be collected (true) or if
                                                                 !< matter should only be collected proportionally to the lost area
