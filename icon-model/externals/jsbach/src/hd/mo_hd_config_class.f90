...
CONTAINS
  ...
  SUBROUTINE Init_hd_config(config)
    ...
    LOGICAL                       :: lrestart_cont           !< continue although HD variables are missing in restart file
    ...
    ! Set defaults
    active                  = .FALSE.
    lrestart_cont           = .FALSE.   ! TRUE: Continue although HD variables are missing in restart file
