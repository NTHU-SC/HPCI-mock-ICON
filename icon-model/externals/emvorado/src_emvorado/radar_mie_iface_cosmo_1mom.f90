...
!===============================================================================
  ...
  SUBROUTINE radar_mie_1mom_vec(myproc, lambda_radar, itype_gscp_fwo, &
       ...
       itype_Dlim_sgh, Dlim_rain, Dlim_drysnow, Dlim_meltsnow, Dlim_meltgraupel )
    ...
    INTEGER, INTENT(in), OPTIONAL               :: itype_Dlim_sgh ! Option to choose how to implement the size limitation of dry/melting snow and melting graupel: 
                                                                  ! 0 = no limitation
                                                                  ! 1 = D>Dlim --> Dlim
    ...
    REAL(KIND=dp) :: zh, ah, &
                     zv, rrhv, irhv, kdp, adp, zvh, Dlim_r, Dlim_ds, Dlim_ms, Dlim_mg
    ...
    IF (llookup) THEN
      ...
      IF (ldo_qs) THEN
        ...
        IF (ilkup_meltsnow < 0) THEN
          ...
          look_Z_meltsnow(nlkup_meltsnow)%chydroconfig     = TRIM(chydroconfig_Dlim)
      ...
      IF (ldo_qg) THEN
        ...
        IF (ldynamic_wetgrowth_gh .AND. Tmeltbegin_g < T0C_fwo) THEN
          ...
          CALL hash_radar_lookup ( &
               ctableconfig, chydroconfig_Dlim, cbaseconfig_g_0C, &
