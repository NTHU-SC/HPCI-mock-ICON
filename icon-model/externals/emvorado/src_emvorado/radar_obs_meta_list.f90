...
! Modules used:
  ...
  USE radar_data, ONLY : &
       ...
       c_dwd, c_meteoswiss, c_arpasim, c_belgium, c_denmark, c_france, &
       c_poland, c_czech, c_netherlands, c_slovakia, &       
       nradsta_all,     &
       nradsta_dwd,     &
       nradsta_swiss,   &
       nradsta_france,   &
...
CONTAINS
  ...
  FUNCTION get_meta_proto_dwd ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_dwd//"XXX"                    ! Short name of station
    m%station_id    = 999999
    ...
    m%az_start    = 0.5_dp       ! center of "regular" first azimuth bin [deg]
    m%naz         = 360
...
!!$    m%ra_start    = 1000.0_dp
    ...
    m%dalpha      = 1.0_dp       ! azimuthal averaging interval for calculation of one averaged pulse
    ...
    m%smth_interv_fact = 1.29_dp ! Factor to determine the azimuthal and elevational integration range
  ...
  FUNCTION get_meta_proto_swiss ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_meteoswiss//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
    m%lambda      = 0.055_dp
    m%icountry    = icountry
...
!!$    m%ra_start    = 1000.0_dp
  ...
  FUNCTION get_meta_proto_italy ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_arpasim//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
!!$ FIXME: does this really have to be such exact? If other countries in the same band (C-, X-, S-) are present in the same run, it is more efficient to make them the same wavelength!
    ...
    m%az_start    = 0.45_dp      ! center of "regular" first azimuth bin [deg]
    m%naz         = 400
...
!!$    m%ra_start    = 1000.0_dp
    ...
    m%dalpha      = 0.9_dp       ! azimuthal averaging interval for calculation of one averaged pulse
                                 !   (averaging over the number of statistically independent pulses)
    m%alpha3_eff_0 = 1.461_dp    ! dummy value for the effective horizontal 3-dB-oneway beam width at elevation = 0.0.
                                 !   Depends on the ratio (dalpha/phi3) - has to be exaclty determined later!
                                 !   The provisional value 1.461 is valid for dalpha/phi3 = 1.0
  ...
  FUNCTION get_meta_proto_belgium ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_belgium//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
    m%lambda      = 0.055_dp
    m%icountry    = icountry
...
!!$    m%ra_start    = 1000.0_dp
  ...
  FUNCTION get_meta_proto_denmark ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_denmark//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
    m%lambda      = 0.055_dp
    m%icountry    = icountry
    ...
    m%az_start    = 0.0_dp       ! center of "regular" first azimuth bin [deg]
    m%naz         = 360
    m%naz_ncdf(:,:) = 360        ! dummy obs file azi dimension, will be read from obs files
    m%az_inc      = 1.0_dp
!!$    m%ra_start    = 1000.0_dp
  ...
  FUNCTION get_meta_proto_france ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_france//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
    m%lambda      = 0.055_dp
    m%icountry    = icountry
...
!!$    m%ra_start    = 1000.0_dp
  ...
  FUNCTION get_meta_proto_poland ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_poland//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
    m%lambda      = 0.055_dp
    m%icountry    = icountry
...
!!$    m%ra_start    = 1000.0_dp
  ...
  FUNCTION get_meta_proto_czech ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_czech//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
    m%lambda      = 0.055_dp
    m%icountry    = icountry
...
!!$    m%ra_start    = 1000.0_dp
  ...
  FUNCTION get_meta_proto_netherlands ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_netherlands//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
    m%lambda      = 0.055_dp
    m%icountry    = icountry
...
!!$    m%ra_start    = 1000.0_dp
  ...
  FUNCTION get_meta_proto_slovakia ( icountry ) RESULT(m)
    ...
    !
    m%station_name  = c_slovakia//"XXX"                    ! Short name of station
    m%station_id    = 999999
    m%ista          = 999                      ! internal station index; will be automatically set after namelist reading
    m%lambda      = 0.055_dp
    m%icountry    = icountry
...
!!$    m(:)         = get_meta_proto_dwd ()
  ...
  !==============================================================================
  !+ Module procedure in radar_src for retrieving the azimuth-dependend
