...
!$omp end do nowait
  ...
  !> copy state, omp parallel, does not wait for other threads to complete
  SUBROUTINE copy_1d_sp(src, dest, lacc, opt_acc_async_queue)
  ...
  !> copy state, omp parallel, does not wait for other threads to complete
  SUBROUTINE copy_2d_sp(src, dest, lacc, opt_acc_async_queue)
    REAL(sp), INTENT(IN) :: src(:, :)
    REAL(sp), INTENT(OUT) :: dest(:, :)
    LOGICAL, INTENT(IN) :: lacc
    INTEGER, INTENT(IN), OPTIONAL :: opt_acc_async_queue
...
!$omp end do nowait
  ...
  !> copy state, omp parallel, does not wait for other threads to complete
  SUBROUTINE copy_3d_sp(src, dest, lacc, opt_acc_async_queue)
    REAL(sp), INTENT(IN) :: src(:, :, :)
    REAL(sp), INTENT(OUT) :: dest(:, :, :)
    LOGICAL, INTENT(IN) :: lacc
    INTEGER, INTENT(IN), OPTIONAL :: opt_acc_async_queue
...
!$omp end do nowait
  ...
  !> copy state, omp parallel, does not wait for other threads to complete
  SUBROUTINE copy_4d_sp(src, dest, lacc, opt_acc_async_queue)
    REAL(sp), INTENT(IN) :: src(:, :, :, :)
    REAL(sp), INTENT(OUT) :: dest(:, :, :, :)
    LOGICAL, INTENT(IN) :: lacc
    INTEGER, INTENT(IN), OPTIONAL :: opt_acc_async_queue
...
!$omp end do nowait
  ...
  !> copy state, omp parallel, does not wait for other threads to complete
  SUBROUTINE copy_2d_dpsp(src, dest, lacc, opt_acc_async_queue)
    REAL(dp), INTENT(IN) :: src(:, :)
    REAL(sp), INTENT(OUT) :: dest(:, :)
    LOGICAL, INTENT(IN) :: lacc
    INTEGER, INTENT(IN), OPTIONAL :: opt_acc_async_queue
...
!$omp end do nowait
  ...
  !> copy state, omp parallel, does not wait for other threads to complete
  SUBROUTINE copy_3d_dpsp(src, dest, lacc, opt_acc_async_queue)
    REAL(dp), INTENT(IN) :: src(:, :, :)
    REAL(sp), INTENT(OUT) :: dest(:, :, :)
    LOGICAL, INTENT(IN) :: lacc
    INTEGER, INTENT(IN), OPTIONAL :: opt_acc_async_queue
...
!$omp end do nowait
  ...
  !> copy state, omp parallel, does not wait for other threads to complete
  SUBROUTINE copy_4d_dpsp(src, dest, lacc, opt_acc_async_queue)
    REAL(dp), INTENT(IN) :: src(:, :, :, :)
    REAL(sp), INTENT(OUT) :: dest(:, :, :, :)
    LOGICAL, INTENT(IN) :: lacc
    INTEGER, INTENT(IN), OPTIONAL :: opt_acc_async_queue
...
!$omp end do nowait
  ...
  !> copy state, omp parallel, does not wait for other threads to complete
  SUBROUTINE copy_5d_dpsp(src, dest, lacc, opt_acc_async_queue)
    REAL(dp), INTENT(IN) :: src(:, :, :, :, :)
    REAL(sp), INTENT(OUT) :: dest(:, :, :, :, :)
    LOGICAL, INTENT(IN) :: lacc
    INTEGER, INTENT(IN), OPTIONAL :: opt_acc_async_queue
