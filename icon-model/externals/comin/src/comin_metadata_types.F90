...
MODULE comin_metadata_types
  ...
  USE comin_keyval_ifc,      ONLY: comin_keyval_create_c, comin_keyval_delete_c, &
                               &   comin_keyval_get_bool_c, comin_keyval_get_char_c, &
                               &   comin_keyval_get_double_c, comin_keyval_get_int_c, &
                               &   comin_keyval_iterator_begin_c, comin_keyval_iterator_compare_c, &
                               &   comin_keyval_iterator_delete_c, comin_keyval_iterator_end_c, &
                               &   comin_keyval_iterator_get_key_c, comin_keyval_iterator_next_c, &
                               &   comin_keyval_query_c, comin_keyval_set_bool_c, &
                               &   comin_keyval_set_char_c, comin_keyval_set_double_c, &
