...
MODULE comin_setup
  ...
  USE comin_keyval_ifc,      ONLY: comin_varmap_new
...
CONTAINS
 ...
 !! @ingroup host_interface
  SUBROUTINE comin_plugin_primaryconstructor(plugin_list)
    ...
    CALL comin_varmap_new(state%comin_var_list)
  ...
  !!
  SUBROUTINE comin_setup_init(lstdout, output_unit)
    LOGICAL, INTENT(IN)           :: lstdout     !< do print on stdout or not
    INTEGER, INTENT(IN), OPTIONAL :: output_unit !< output unit to print messages to
