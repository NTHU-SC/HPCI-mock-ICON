...
- `COMIN_DIM_SEMANTICS_BLOCK` (int)
- `COMIN_DIM_SEMANTICS_CONTAINER` (int)
- `COMIN_DIM_SEMANTICS_LEVEL` (int)
- `COMIN_DIM_SEMANTICS_NPROMA` (int)
- `COMIN_DIM_SEMANTICS_OTHER` (int)
- `COMIN_DIM_SEMANTICS_UNBLOCK` (int)
- `COMIN_DIM_SEMANTICS_UNDEF` (int)
- `COMIN_DIM_SEMANTICS_UNUSED` (int)
...
- `COMIN_VAR_DATATYPE_DOUBLE` (int)
- `COMIN_VAR_DATATYPE_FLOAT` (int)
- `COMIN_VAR_DATATYPE_INT` (int)
- `COMIN_ZAXIS_2D` (int)
- `COMIN_ZAXIS_3D` (int)
